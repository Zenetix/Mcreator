...
public class SaphireBlockBlock extends GodmodModElements.ModElement {
	@ObjectHolder("godmod:saphire_block")
	public static final Block block = null;
	public SaphireBlockBlock(GodmodModElements instance) {
		super(instance, 12);
	}
