...
public class PlatineBlockBlock extends GodmodModElements.ModElement {
	@ObjectHolder("godmod:platine_block")
	public static final Block block = null;
	public PlatineBlockBlock(GodmodModElements instance) {
		super(instance, 47);
	}
